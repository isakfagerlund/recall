...
// ../../node_modules/.bun/@cloudflare+unenv-preset@2.7.11+2d40b94f8b0ac4cc/node_modules/@cloudflare/unenv-preset/dist/runtime/polyfill/performance.mjs
...
// ../../node_modules/.bun/@cloudflare+unenv-preset@2.7.11+2d40b94f8b0ac4cc/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// ../../node_modules/.bun/wrangler@4.50.0+5a562267c186eae0/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
...
// ../../node_modules/.bun/@cloudflare+unenv-preset@2.7.11+2d40b94f8b0ac4cc/node_modules/@cloudflare/unenv-preset/dist/runtime/node/process.mjs
...
// ../../node_modules/.bun/wrangler@4.50.0+5a562267c186eae0/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/request/constants.js
var GET_MATCH_RESULT = Symbol();

// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/utils/body.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/utils/url.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/utils/html.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/context.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/router.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/utils/constants.js
var COMPOSED_HANDLER = "__COMPOSED_HANDLER";

// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/hono-base.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/router/reg-exp-router/matcher.js
var emptyParam = [];
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/router/reg-exp-router/node.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/router/reg-exp-router/trie.js
var Trie = class {
  static {
    __name(this, "Trie");
  }
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/router/reg-exp-router/router.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/router/smart-router/router.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/router/trie-router/node.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/router/trie-router/router.js
...
// ../../node_modules/.bun/hono@4.10.6/node_modules/hono/dist/hono.js
...
transcribe.post("/", async (c) => {
  try {
    ...
    if (!response.ok) {
      ...
      const statusCode = response.status >= 400 && response.status < 500 ? 400 : 500;
    ...
    console.error("Error transcribing audio:", error3);
    const message = error3 instanceof Error ? error3.message : "Failed to transcribe audio";
    return c.json({ error: message }, 500);
  }
});
var transcribe_default = transcribe;
...
// src/lib/db.ts
function getDbClient(databaseUrl) {
  if (!databaseUrl) {
    throw new Error("DATABASE_URL is not configured");
  }
  return cs(databaseUrl);
}
...
async function storeSyncData(syncKey, encryptedData, databaseUrl) {
...
__name(storeSyncData, "storeSyncData");
async function getSyncData(syncKey, databaseUrl) {
  await initializeDatabase(databaseUrl);
  const sql = getDbClient(databaseUrl);
...
__name(getSyncData, "getSyncData");

// src/lib/auth.ts
import { createHash } from "crypto";
function verifyHmacSignature(data, key, signature) {
...
pull.get("/", async (c) => {
  try {
    ...
    console.error("Error in pull sync:", error3);
    const message = error3 instanceof Error ? error3.message : "Internal server error";
    return c.json({ error: message }, 500);
  }
});
var pull_default = pull;

// src/routes/sync/push.ts
var push = new Hono2();
push.post("/", async (c) => {
  try {
    const body = await c.req.json();
    ...
    await storeSyncData(syncKey, data, c.env.DATABASE_URL);
    return c.json({ success: true });
  } catch (error3) {
    console.error("Error in push sync:", error3);
    const message = error3 instanceof Error ? error3.message : "Internal server error";
    return c.json({ error: message }, 500);
  }
});
...
var app = new Hono2();
app.use("/*", cors());
app.route("/api/transcribe", transcribe_default);
var sync = new Hono2();
sync.route("/pull", pull_default);
sync.route("/push", push_default);
app.route("/sync", sync);
app.get("/health", (c) => {
...
// ../../node_modules/.bun/wrangler@4.50.0+5a562267c186eae0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.bun/wrangler@4.50.0+5a562267c186eae0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-hJoYds/middleware-insertion-facade.js
...
// ../../node_modules/.bun/wrangler@4.50.0+5a562267c186eae0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-hJoYds/middleware-loader.entry.ts
